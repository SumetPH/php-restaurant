				...
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="row justify-content-center">
							<div class="col-md-6">
								<form action="del_form.php" method="get">
									...
									<form action="del.php" method="post">
										...
										<div class="form-group">
											...
											<input 
												...
												type="text" 
												disabled
												<?php if($row[menu_Type] == 1) echo "value='อาหารคาว'";?>
												<?php if($row[menu_Type] == 2) echo "value='อาหารหวาน'";?>
												<?php if($row[menu_Type] == 3) echo "value='อาหารว่าง'";?>
												>
										</div>
										<div class="form-group">
											<label>ราคา</label>
